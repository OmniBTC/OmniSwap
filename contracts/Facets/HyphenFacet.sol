...
contract HyphenFacet is ISo, Swapper, ReentrancyGuard {
    /// Storage ///

    bytes32 internal constant NAMESPACE = hex"b4dba59cea9741f069693c5cc9e154fe2190cf9db6275fa7f1075a6a6c6668cc"; // keccak256("com.so.facets.hyphen")
    struct Storage {
    ...
    function startBridgeTokensViaHyphen(SoData calldata _soData, HyphenData calldata _hyphenData)
        external
        payable
        nonReentrant
    {
    ...
    function swapAndStartBridgeTokensViaHyphen(
        ...
        _hyphenData.amount = _executeAndCheckSwaps(_soData, _swapData);
        _startBridge(_hyphenData);
