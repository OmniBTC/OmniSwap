...
contract AnyswapFacet is ISo, Swapper, ReentrancyGuard {
    /// Types ///
    ...
    function startBridgeTokensViaAnyswap(SoData calldata _soData, AnyswapData calldata _anyswapData)
        external
        payable
        nonReentrant
    {
    ...
    function swapAndStartBridgeTokensViaAnyswap(
        ...
        _anyswapData.amount = _executeAndCheckSwaps(_soData, _swapData);
        (address underlyingToken, bool isNative) = _getUnderlyingToken(_anyswapData.token, _anyswapData.router);
        _startBridge(_anyswapData, underlyingToken, isNative);
