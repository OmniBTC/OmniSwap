...
contract CBridgeFacet is ISo, Swapper, ReentrancyGuard {
    /// Storage ///

    bytes32 internal constant NAMESPACE = hex"86b79a219228d788dd4fea892f48eec79167ea6d19d7f61e274652b2797c5b12"; //keccak256("com.so.facets.cbridge2");
    struct Storage {
        address cBridge;
    ...
    function startBridgeTokensViaCBridge(SoData calldata _soData, CBridgeData calldata _cBridgeData)
        external
        payable
        nonReentrant
    {
    ...
    function swapAndStartBridgeTokensViaCBridge(
        ...
        _cBridgeData.amount = _executeAndCheckSwaps(_soData, _swapData);
        _startBridge(_cBridgeData);
