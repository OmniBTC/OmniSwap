...
use super::relayer_fee::{check_relayer_fee, CheckRelayerFee};
use crate::{
...
impl<'info> CheckRelayerFee<'info> for Context<'_, '_, '_, '_, SoSwapNativeWithoutSwap<'info>> {
...
pub fn handler(ctx: Context<SoSwapNativeWithoutSwap>) -> Result<()> {
