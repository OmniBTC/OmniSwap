...
use crate::state::redeemer_config::RedeemerConfig;
use crate::context::CompleteSoSwapWrappedWithoutSwap;
...
pub fn handler(
    ...
    require!(
        *soswap_message != Default::default(),
        SoSwapError::DeserializeSoSwapMessageFail,
    );
    require!(
